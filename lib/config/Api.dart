class Api{
  static const _host='http://192.168.33.200/api-mobile-d1'; //* Ini adalah konstanta statis yang menyimpan URL dasar (base URL) dari API yang akan diakses. URL ini menunjuk ke server lokal (127.0.0.1) dan ke direktori api-mobile-d1.
